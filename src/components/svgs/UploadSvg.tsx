const UploadSvg = () => {
  return (
    <svg viewBox='0 0 480 360' xmlns='http://www.w3.org/2000/svg'>
      ...
      />
      <ellipse cx='390.052' cy='264.383' fill='var(--primary-300)' fillRule='nonzero' opacity='0.1' rx='5.044' ry='1' />
      <path
        fill='var(--primary-300)'
        fillRule='nonzero'
      ...
      />
      <circle cx='303.613' cy='103.507' r='9.376' fill='var(--primary-300)' fillRule='nonzero' opacity='0.2' />
      <path
        fill='var(--primary-300)'
        fillRule='nonzero'
      ...
      <path
        ...
        opacity='0.32'
      />
      <ellipse cx='119.593' cy='258.664' fill='var(--primary-300)' fillRule='nonzero' opacity='0.1' rx='4.846' ry='1' />
      <ellipse cx='101.03' cy='260.545' fill='var(--primary-300)' fillRule='nonzero' opacity='0.1' rx='4.846' ry='1' />
      <ellipse cx='108.459' cy='265.905' fill='var(--primary-300)' fillRule='nonzero' opacity='0.1' rx='3.444' ry='1' />
      <ellipse cx='89.193' cy='265.433' fill='var(--primary-300)' fillRule='nonzero' opacity='0.1' rx='3.444' ry='1' />
      <path
        fill='var(--primary-300)'
        fillRule='nonzero'
      ...
      />
      <path stroke='var(--primary-800)' strokeLinecap='round' strokeWidth='0.5' d='M90.344 249.701L92.293 249.701' />
      <path stroke='var(--primary-800)' strokeLinecap='round' strokeWidth='0.5' d='M92.68 254.132L95.738 254.263' />
      <path stroke='var(--primary-800)' strokeLinecap='round' strokeWidth='0.5' d='M94.542 250.586L94.21 252.179' />
      <path stroke='var(--primary-800)' strokeLinecap='round' strokeWidth='0.5' d='M97.792 255.432L97.732 256.879' />
      <path
        fill='var(--primary-300)'
        fillRule='nonzero'
      ...
      />
      <path stroke='var(--primary-800)' strokeLinecap='round' strokeWidth='0.5' d='M111.82 249.701L109.871 249.701' />
      <path stroke='var(--primary-800)' strokeLinecap='round' strokeWidth='0.5' d='M109.485 254.132L106.426 254.263' />
      <path stroke='var(--primary-800)' strokeLinecap='round' strokeWidth='0.5' d='M107.622 250.586L107.954 252.179' />
      <path stroke='var(--primary-800)' strokeLinecap='round' strokeWidth='0.5' d='M104.372 255.432L104.432 256.879' />
      <path
        fill='var(--primary-300)'
        fillRule='nonzero'
      ...
      />
      <circle cx='84.467' cy='87.003' r='6.467' fill='var(--primary-300)' fillRule='nonzero' opacity='0.1' />
      <circle cx='395.425' cy='138.681' r='6.467' fill='var(--primary-300)' fillRule='nonzero' opacity='0.1' />
      <circle cx='279.178' cy='66.467' r='6.467' fill='var(--primary-300)' fillRule='nonzero' opacity='0.1' />
      <circle cx='97.4' cy='122.68' r='10.838' fill='var(--primary-300)' fillRule='nonzero' opacity='0.1' />
      <path
        fill='#007867'
        fillRule='nonzero'
